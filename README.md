 ...
 * In the case of nested subpatterns both can match. Say we wanted "broad" to map to account "ABC123" and "broad special" to map to "DEF456". In this case the pattern should be "(broad( narow)?)" and the accounts "ABC123,DEF456".
